...
##############################################################################
# FILE: (bash script) localpython
# AUTHOR: R-Logik, Deutschland. https://github.com/RLogik/phpytex
# CREATED: 28.07.2020
# DESCRIPTION:
#   script to use the locally install venv version of python
# NOTES:
#
#     Installation:
#     ~~~~~~~~~~~~~
...
#     ~~~~~~~~~~~~~
#
#       ./localpython.sh [ARGUMENTS]
#
#    where the arguments are just as you would use them
#    for the python/python3 command
#
##############################################################################
