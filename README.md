...
folders: # a dictionary with document trees as values
  ...
```
...
It has no built-in _'We can produce these cool graphics with this one command!'_[^1] selling point.
...
[^1]: Nonetheless, with `Phpytex` one can do this and just about any such task.
